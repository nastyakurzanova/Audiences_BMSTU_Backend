...
# Набор методов для заявок (бронирование)
    ...
    path('api/booking/<int:audiences_id>/add_to_audiences/', add_audiences_to_booking),  # POST добавление услуги в заявку
    ...
    path('api/booking/draft/', get_draft_booking),  #! GET
    
  # м-м
    path('api/bookings/<int:booking_id>/delete_audiences/<int:audiences_id>/', delete_substance_from_cosmetic),  # DELETE
    path('api/bookings/<int:booking_id>/audiences/<int:audiences_id>/', get_substance_in_cosmetic),  # GET
    path('api/bookings/<int:booking_id>/update_audiences/<int:audiences_id>/', update_substance_in_cosmetic),  # PUT
